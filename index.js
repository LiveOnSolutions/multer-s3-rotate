...
function S3Storage(opts) {
  ...
  switch (typeof opts.resize) {
    case "boolean":
      this.getResize = staticValue(opts.resize);
      break;
    case "undefined":
      this.getResize = defaultResize;
      break;
    default:
  ...
  if (opts.resize) {
    switch (typeof opts.resizeOpts) {
      case "object":
        this.getResizeOpts = staticValue(opts.resizeOpts);
        break;
      case "undefined":
        throw new TypeError("Expected opts.resize to be undefined or boolean");
      default:
        throw new TypeError("Expected opts.resize to be an object");
    }
  }
...
S3Storage.prototype._handleFile = function(req, file, cb) {
  collect(this, req, file, async function(err, opts) {
    ...
    } else var upload = this.s3.upload(params);
